...
const Header = () => {
  ...
  return (
    <header className="w-full bg-[#09100d] py-3 flex items-center justify-between shadow-md">
      ...
      {/* Logo / Platform Name */}
      <img src={logoImage} alt="Platform Logo" className="max-w-40" />
      {/* Switch Button */}
      <button
        onClick={handleSwitchClick}
        className="bg-[#18ffc8] text-black font-medium px-4 py-2 rounded-lg hover:opacity-90 transition text-sm"
      >
        Switch to User
      </button>
    </header>
